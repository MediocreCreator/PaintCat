...
const data = {
    ...
    "Body Fillers": {
        "UPOL (Best In The Range)": [
            ...
            { name: "Onion Board", image: "Images/Upol & Raptor/Onion Board.png", description: "9123100011 The ONION BOARD is a wax free, clean environment for mixing fillers and materials. Reduces pinholing: specially formulated paper does not soak up resins and solvents."}
        ],
